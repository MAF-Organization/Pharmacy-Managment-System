...
<link rel="stylesheet" href="style/table11.css" type="text/css" media="screen" /> 
...
<p class="ran" > Pharmacy+ </p>
	...
	$qury=mysqli_query($conn, "SELECT * from stock where status='low'") or die();
...
<div id="tabbed_box" class="tabbed_box">  
    ...
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($conn, "SELECT DISTINCT * FROM prescription")or die();
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				<img src="med.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_prescription.php?id=<?php echo $row['invoice_id']?>">
				<img src="https://cdn-icons-png.flaticon.com/512/25/25298.png" width="35" height="35" border="0" /></a></td>
