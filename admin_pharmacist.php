    ...
    <div class="tabbed_area">  
       ...
       $result = mysqli_query($conn, "SELECT * FROM pharmacist")or die(mysql_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				<td><a href="delete_pharmacist.php?id=<?php echo $row['pharmacist_id']?>"><img src="https://cdn-icons-png.flaticon.com/512/25/25298.png" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
