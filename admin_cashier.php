    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array($result )) {
				...
				<td><a href="delete_cashier.php?cashier_id=<?php echo $row['cashier_id']?>"><img src="https://cdn-icons-png.flaticon.com/512/25/25298.png" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
